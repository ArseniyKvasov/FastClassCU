...
app = FastAPI(title="Answers Service", lifespan=lifespan)
install_request_middleware(app, service_name="answers-service")
install_metrics(app, service_name="answers-service")
